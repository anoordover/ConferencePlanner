...
namespace FrontEnd.TagHelpers
{
    ...
    public class AuthzTagHelper : TagHelper
    {
        ...
        [HtmlAttributeName("authz")] public bool RequiresAuthentication { get; set; }

        [HtmlAttributeName("authz-policy")] public string RequiredPolicy { get; set; }
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (context.AllAttributes["authz"] != null && !requiresAuth &&
